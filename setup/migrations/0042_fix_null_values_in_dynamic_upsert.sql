-- =====================================================
-- Migration: 0042_fix_null_values_in_dynamic_upsert.sql
-- Описание: Исправление затирания NULL значениями в dynamic_upsert_entity
-- Дата: 2025-01-21
-- =====================================================
...
-- Создаем исправленную функцию с защитой от NULL
...
BEGIN
    ...
    LOOP
        ...
        -- Пропускаем NULL и пустые строки (чтобы не затереть существующие данные)
