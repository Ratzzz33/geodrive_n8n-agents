...
try {
  console.log('📝 Исправляем функцию dynamic_upsert_entity (ambiguous table_name)...');
  ...
  console.log('✅ Функция dynamic_upsert_entity исправлена');
  console.log('   - Параметры переименованы: p_table_name, p_rentprog_id, p_data');
  console.log('   - Устранена ambiguous reference на table_name');
