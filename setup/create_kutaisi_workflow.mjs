#!/usr/bin/env node
/**
 * Создание Kutaisi workflow на основе Service Center
 */
...
const branch = {
  ...
  code: 'kutaisi',
  company_id: 9360,
  company_token: '5599ebb7a1f0a1e5f6a5d4e3c2b1a0f9e8d7c6b5a4f3e2d1c0b9a8f7e6d5c4b',
  webhook_path: 'kutaisi-webhook'
};

async function createKutaisiWorkflow() {
  console.log('\n🚀 Создание Kutaisi workflow...\n');
  ...
  console.log('✅ Kutaisi workflow готов!\n');
}

createKutaisiWorkflow().catch(err => {
