#!/usr/bin/env node
/**
 * Создание Tbilisi workflow на основе Service Center
 */
...
async function createTbilisiWorkflow() {
  console.log('\n🚀 Создание Tbilisi workflow...\n');
  ...
  if (parseNode) {
    ...
    console.log('   ✓ Parse Webhook обновлен');
  }
  ...
  if (prepareCreateNode) {
    ...
    console.log('   ✓ Prepare Create обновлен');
  }
  ...
  if (tokenNode) {
    ...
    console.log('   ✓ Get RentProg Token обновлен');
  }
  ...
  console.log('✅ Tbilisi workflow готов!\n');
}

createTbilisiWorkflow().catch(err => {
