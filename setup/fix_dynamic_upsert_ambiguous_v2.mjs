...
try {
    ...
    BEGIN
      ...
      ELSE
        ...
        sql_query := format(
          ...
          p_table_name, update_list, new_id
        );
      END IF;
  ...
  console.log('✅ Функция dynamic_upsert_entity пересоздана');
  console.log('   - Параметры: p_table_name, p_rentprog_id, p_data');
  console.log('   - Устранена ambiguous reference');
  console.log('   - Автоматически создаются записи в external_refs');
