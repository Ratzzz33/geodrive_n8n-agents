...
async function fixPricesExtraction() {
  ...
  // Исправляем ноду "Merge & Process" - добавляем обработку responseData.cars.included
  console.log('🔧 Исправляю ноду "Merge & Process" (добавляю обработку responseData.cars.included)...');
  ...
  // Обновляем код - добавляем обработку разных вариантов структуры included
  const currentCode = mergeProcessNode.parameters.jsCode;
  
  // Ищем строку с извлечением included
  ...
  console.log('✅ Нода "Merge & Process" обновлена с обработкой responseData.cars.included\n');
  ...
  console.log('  ✅ Добавлена обработка responseData.cars.included');
  console.log('  ✅ Добавлена обработка responseData.data.included');
  console.log('  ✅ Сохранена обратная совместимость с responseData.included');
