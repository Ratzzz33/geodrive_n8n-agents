...
# -*- coding: utf-8 -*-
"""
Запуск fill_car_prices.mjs с выводом в реальном времени
"""
...
def run_with_output():
    ...
    try:
        ...
        print("🚀 Запуск обновления цен машин по всем филиалам...\n")
        print("=" * 80)
        
        stdin, stdout, stderr = ssh.exec_command(
            'cd /root/geodrive_n8n-agents && node setup/fill_car_prices.mjs',
            get_pty=True
        )
