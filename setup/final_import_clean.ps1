...
Write-Host "Importing: RentProg Upsert Processor" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Workflow: $($wfJson.name)"
Write-Host ""
...
Write-Host "Sending to n8n..." -ForegroundColor Yellow
...
try {
    ...
    Write-Host "1. Open workflow in n8n"
    Write-Host "2. Set PostgreSQL credentials in nodes"
    Write-Host "3. Activate workflow"
    ...
    Write-Host ""
    Write-Host "Alternative: Manual import at http://46.224.17.15:5678" -ForegroundColor Yellow
