# ⚠️ Legacy: финальные инструкции по Netlify-настройке (архив)

> **Примечание:** После миграции на Nginx (`n8n.rentflow.rentals` / `webhook.rentflow.rentals`) эти инструкции не актуальны. Документ сохранён только для истории.
